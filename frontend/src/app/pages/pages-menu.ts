...
export const MENU_ITEMS: NbMenuItem[] = [
  ...
  
  {
    ...
    link: '/stopmarcel/declarations',
  },
  {
    title: 'Collaborateurs',
    icon: 'people-outline'    ,
    link: '/stopmarcel/collaborateurs',
  },
  {
    title: 'Statistiques',
    icon: 'pie-chart-outline',
    link: '/stopmarcel/statistiques',
  },
  {
    title: 'STOPMARCEL COLLAB',
    group: true,
  },
  {
    title: 'STOPMARCEL ADMIN',
    group: true,
  },
  {
    title: 'Entreprises',
    icon: 'file-text-outline',
    link: '/stopmarcel/entreprises',
  },
  {
    title: 'Modérateur',
    icon: 'people-outline'    ,
